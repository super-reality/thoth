...
export class EntityManager extends ThothComponent<
...
> {
  ...
  builder(node: ThothNode) {
    ...
    const dataAgentName = new Rete.Output('dataAgentName', 'XR Engine Agent Name', stringSocket)
    const dataRoomUrl = new Rete.Output('dataRoomUrl', 'XR Engine Room URL', stringSocket)
    const dataTwitterId = new Rete.Output('dataTwitterId', 'Twitter ID', stringSocket)
    const dataDiscordId = new Rete.Output('dataDiscordId', 'Discord ID', stringSocket)
    ...
    return node
      .addInput(dataInput)
    //   .addOutput(out)
      .addOutput(dataAgentName)
      .addOutput(dataRoomUrl)
      .addOutput(dataTwitterId)
      .addOutput(dataDiscordId)
